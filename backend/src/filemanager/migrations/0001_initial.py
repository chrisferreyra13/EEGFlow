...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('process_id', models.CharField(max_length=22, primary_key=True, serialize=False, validators=[django.core.validators.MinLengthValidator(22)])),
                ('file_id', models.CharField(default='MNMNMNMNMNMNMNMNMNMN', max_length=22, validators=[django.core.validators.MinLengthValidator(22)])),
                ('file', models.FileField(blank=True, storage=filemanager.models.FileManagerProcessesSystemStorage(), upload_to=filemanager.models.get_file_path)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('file_type', models.CharField(choices=[('F', 'File data'), ('U', 'Remote file URL')], max_length=1)),
                ('process_type', models.CharField(blank=True, max_length=50)),
