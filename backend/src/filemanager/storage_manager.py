...
#               requires that you have the FILEMANAGER_FILE_STORE_PATH
...
import re
import shortuuid
from filemanager.models import TemporaryUpload, StoredUpload
...
# the FILEMANAGER_FILE_STORE_PATH configuration setting (for local
